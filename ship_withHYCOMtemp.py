...
'''
old version
shipData=pd.read_csv('shipdata.csv')       
...
for i in shipTime.index:
    ...
    Modtemp.append(t)
    print i
shipData['modtemp_HYCOM']=pd.Series(Modtemp,index=good_index)
